	...
	<div class="card">
    	...
    	<div  class="navigation">
      		<ul>
  				...
  				<li style="margin-top:10px;"><a href="PendingTransfer.jsp" class="active">Requested Transfer History</a></li>
		...
		<div class="container">
			<h1 style="text-align: center;font-size:30px">Requested Transfer History</h1>
	...
	<c:forEach var="Transfer" items="${transferDetails}">
		...
		<c:param name="approveBy" value="${approveBy}"/>
			...
			<tr>
				...
				<td>Pending</td>
				<td>22.04.2021</td>
				<td><a href="${transferUpdate}"><button> E</button></a></td>
				<td><a href="${transferDelete}"><button> D</button></a></td>
			</tr>
