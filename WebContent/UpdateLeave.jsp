...
<body>
	...
	<div class="modal-content animate">
		...
		<h1 align ="center"> Update My Leaves </h1>
	...
	<table>
		...
		<tr>
			<td>Employee ID</td>
			<td><input type="text" name="empID" value="<%= empID %>" required></td>
		</tr>
		<tr>
			<td>Leave Code</td>
			<td>
			<select id="type" name="leaveCode" required>
				<option value="<%= leaveCode %>"><%= leaveCode %></option>
		...
		<tr>
			<td>From</td>
			<td><input type="date" name="fdate" value="<%= fdate %>" required></td>
		</tr>

		<tr>
			<td>To</td>
			<td><input type="date" name="tdate" value="<%= tdate %>" required></td>
		</tr>
	...
	<input type="submit" value="Update My Leave">
	</form>
	</div>
	</div>
