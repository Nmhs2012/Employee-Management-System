...
<body>
	...
	<div class="card">
		...
		<h1 style="text-align: center;font-size:30px">Update Transfer Requisition Details</h1>
	...
	<form action="UpdateTransferServlet" method="post">
			...
			<label>6.  Reason for Transfer:</label><br/>
			 <input type="text" name="reason" value="<%= reason%>"  maxlength="100" placeholder="Comments..." required><br/>
